insert into book (external_id, title, author, description, pages, picture_url, rating, year) values ('fC8kzwEACAAJ', 'Gdzie śpiewają raki', 'Delia Owens', 'Światowa sensacja, bijący wszelkie rekordy fenomen, który przykuł uwagę ponad 13 milionów czytelników.
...
insert into book (external_id, title, author, description,  pages, picture_url, rating, year) values ('qb5hAAAAMAAJ','Opowieści o pilocie Pirxie', 'Stanisław Lem', 'Jedna z najbardziej znanych i lubianych książek Lema', 515, 'https://s.lubimyczytac.pl/upload/books/148000/148887/352x500.jpg', 7.9, 2012);
